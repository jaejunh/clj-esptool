...
(def a-4-2 "select irstream symbol, sum(price) from MarketData.win:time(5.50 sec) output every 1 seconds")
...
;; help
;; TODO: need more clean up on symbols: market-data-property, k, a-4-2
(println " ")
(println " ")
