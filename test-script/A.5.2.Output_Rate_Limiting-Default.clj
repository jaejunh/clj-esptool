...
(def a-5-2 "select irstream symbol, sum(price) from MarketData.win:time(5.50 sec) group by symbol output every 1 seconds")
...
;; help
;; TODO: need more clean up on symbols: market-data-property, k, a-5-2
(println " ")
(println " ")
