...
(def a-3-2 "select irstream sum(price) from MarketData.win:time(5.50 sec) output every 1 seconds")
...
;; help
;; TODO: need more clean up on symbols: market-data-property, k, a-3-2
(println " ")
(println " ")
