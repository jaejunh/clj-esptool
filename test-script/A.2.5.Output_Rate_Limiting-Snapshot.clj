...
(def a-2-5 "select irstream symbol, volume, price from MarketData.win:time(5.50 sec) Output snapshot every 1 seconds")
...
;; help
;; TODO: need more clean up on symbols: market-data-property, k, a-2-5
(println " ")
(println " ")
