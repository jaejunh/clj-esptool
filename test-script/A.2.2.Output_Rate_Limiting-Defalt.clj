...
(def a-2-2 "select irstream symbol, volume, price from MarketData.win:time(5.50 sec) Output every 1 seconds")
...
;; help
;; TODO: need more clean up on symbols: market-data-property, k, a-2-2
(println " ")
(println " ")
