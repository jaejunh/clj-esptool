...
(def a-5-1 "select irstream symbol, sum(price) from MarketData.win:time(5.50 sec) group by symbol order by symbol")
...
;; help
;; TODO: need more clean up on symbols: market-data-property, k, a-5-1
(println " ")
(println " ")
