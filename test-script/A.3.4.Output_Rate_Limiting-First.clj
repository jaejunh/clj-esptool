...
(def a-3-4 "select irstream sum(price) from MarketData.win:time(5.50 sec) output first every 1 seconds")
...
;; help
;; TODO: need more clean up on symbols: market-data-property, k, a-3-4
(println " ")
(println " ")
