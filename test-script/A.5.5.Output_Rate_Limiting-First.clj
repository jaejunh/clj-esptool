...
(def a-5-5 "select irstream symbol, sum(price) from MarketData.win:time(5.50 sec) group by symbol output first every 1 seconds")
...
;; help
;; TODO: need more clean up on symbols: market-data-property, k, a-5-5
(println " ")
(println " ")
