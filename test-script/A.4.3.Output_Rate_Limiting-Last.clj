...
(def a-4-3 "select irstream symbol, sum(price) from MarketData.win:time(5.50 sec) output last every 1 seconds")
...
;; help
;; TODO: need more clean up on symbols: market-data-property, k, a-4-3
(println " ")
(println " ")
